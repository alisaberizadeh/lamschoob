                    ...
                    <div class="card radius-10 mb-3 border-top border-0 border-4 border-info radius-10 ">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-info">کد های تخفیف</h5>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($discountCode as $item)
                                            <tr>
                                                ...
                                                <td>{{ verta($item->expiration_date) }}</td>
                                                <td>
                                                    @if ($item->expiration_date > Illuminate\Support\Carbon::now())
                                                    <span class="badge bg-light-success text-success"> معتبر </span>
                                                    @else
                                                    <span class="badge bg-light-danger text-danger"> معتبر نیست</span>
                    ...
                    <div class="card  border-top border-0 border-4 border-info radius-10 mb-0">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-info"> کد تخفیف جدید </h5>
                            </div>
                            <hr>
                            ...
                            <form class="row g-3" action="{{ route('discounts.new') }}" method="POST"
                                ...
                                <div class="col-md-4">
                                    <label class="form-label"><span class="text-danger">*</span> اعتبار تا چند روز ؟</label>
                                    <input type="number" name="expiration_date" value="{{ old('expiration_date') }}"
                                        class="form-control ">
                                </div>
