                    ...
                    <div class="card radius-10 mb-3 border-top border-0 border-4 border-info radius-10 ">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-info">دسته بندی محصولات </h5>
                            </div>
                                                ...
                                                <td>
                                                    <div class="d-flex order-actions">
                                                        <form action="{{ route('categories.delete', $item->id) }}"
                                                            method="POST" id="delete_form"> @csrf @method('delete')</form>
                                                        <a href="sliders/delete"
                                                            onclick="event.preventDefault();document.getElementById('delete_form').submit()"
                                                            class="text-danger bg-light-danger border-0"><i
                                                                class='bx bxs-trash'></i></a>
                                                        <a href="{{route('categories.edit',$item->id)}}" class="text-primary ms-5 bg-light-primary border-0"><i class='bx bxs-edit'></i></a>
                    ...
                    <div class="card  border-top border-0 border-4 border-info radius-10 mb-0">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-info"> دسته بندی جدید </h5>
                            </div>
                            <hr>
                            ...
                            <form class="row g-3" action="{{ route('categories.new') }}" method="POST"
