                    ...
                    <div class="card radius-10 mb-3 border-top border-0 border-4 border-info radius-10 ">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-info"> بخش محبوب ترین ها </h5>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex order-actions"> 
                                                        <a href="{{ route('setting.favorites.delete', $item->id) }}"
                ...
                <div class="col-lg-6">
                    <div class="card  border-top border-0 border-4 border-info radius-10 mb-0">
                        <div class="card-body">
                            ...
                            <form class="row g-3 d-flex justify-content-between" action="{{ route('setting.favorites.add') }}" method="POST"
