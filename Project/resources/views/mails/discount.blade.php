...
<body>
    <div style="width: 100%;text-align: center">
        ...
        <div
            ...
            <h4 style="font-family:IRANSans ">تبریک ، با توجه به استفاده شدن کد معرف شما برای عضویت در سایت "لمس چوب" ،
                یک هدیه برای شما داریم . </h4>
            <h4>فروشگاه اینترنتی "لمس چوب" یک کد تخفیف بدون تاریخ انقضا برای شما در نظر گرفته است</h4>
            <h4 style="color: red;font-weight: bold">کد تخفیف :
                <span
                    style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                    {{ $discount }}</span>
            </h4>
            <h4>از شما متشکریم . </h4>
            <br><br><br><br>
            <h5>
                <span
